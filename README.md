...
<div align="center">
  <img src="concept.svg" alt="Concept diagram" width="420">
</div>
...
### 31-key modular design

Each unit is a self-contained block. Connect multiple blocks together via I²C to scale up your instrument. This allows for a low initial investment in something that can be expanded gradually over time.
...
Uses the same low-cost, widely available switches found in modern gaming keyboards. Hot-swappable so you can try different switches or easily replace any that become defective.
